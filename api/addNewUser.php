<?php
    ...
    $sql = "INSERT INTO users 
            (userName, passWord, lastName, firstName, middleName, contactNumber, email, gender, birthDate, registerDate, picture)
            VALUES 
            (
                '{$userData['userName']}',
                '{$userData['passWord']}',
